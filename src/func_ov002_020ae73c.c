...
void func_ov002_020ae73c(char* c, char* arg)
{
    ...
    *(int*)(int)(((long long)(int)(c + 0x98)) & 0xFFFFFFFFFFFFFFFFLL) =
        *(int*)(int)(((long long)(int)(c + 0x98)) & 0xFFFFFFFFFFFFFFFFLL) / 6;
    *(s16*)(c + 0x102) = 8;
    *(int*)(int)(((long long)(int)(c + 0xb0)) & 0xFFFFFFFFFFFFFFFFLL) &= ~1;
