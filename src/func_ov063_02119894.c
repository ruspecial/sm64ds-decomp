...
{
    *(unsigned short *)(((int)c + 0x5d4) & 0xFFFFFFFFFFFFFFFFLL) &= ~0x40;
    if (*(unsigned short *)(c + 0x100) == 0) {
        *(int *)(c + 0x588) = (((unsigned)RandomIntInternal(&data_0209e650) >> 16) & 0xfff) * 5;
        *(int *)(c + 0x58c) = (int)((((long long)(int)(((unsigned)RandomIntInternal(&data_0209e650) >> 16) & 0xfff) << 7) + 0x800) >> 12);
    }
